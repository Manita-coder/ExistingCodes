...
public class SA360_GoogleAccountManager {

	public SA360_GoogleAccountManager(WebDriver driver) {
	...
	private WebElement pwdNext_btn_signin;
	...
	private WebElement onEnterPasswordPage;

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	@FindBy(how = How.XPATH, using = "//*[contains(text(),'Forgot email?')]")
	private WebElement onEnterEmailPage_forgot;
	@FindBy(how = How.XPATH, using = ".//*[@id='identifierNext']")
	private WebElement emailNext_btn;
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	@FindBy(how = How.XPATH, using = "//*[contains(text(),'Find my account')]")
	private WebElement onEnterEmailPage_FindMyAccount;
	@FindBy(how = How.XPATH, using = ".//*[@id='next']")
	private WebElement emailNext_btn_findmyaccount;
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void enterEmail_next(String email) {
		...
		if (su.exists_Quick(onEnterEmailPage_forgot)) {
			su.click(emailNext_btn);
		} else if (su.exists_Quick(onEnterEmailPage_FindMyAccount)) {
			su.click(emailNext_btn_findmyaccount);
		}
		su.sleep(2000);
	}
	...
	public void enterPassword_next(String pwd) {
		...
		if (su.exists_Quick(pwdNext_btn)) {
			su.click(pwdNext_btn);
		} else if (su.exists_Quick(pwdNext_btn_signin)) {
			su.click(pwdNext_btn_signin);
		}
	}
...
//===============================================================================>
		...
		/*
		 * if (isAdvertisemsentLinkPresent()) { clickOnAdvertiserLink(); } else {
		 * loadPagesByTabPower(); su.click("xpath", mainCammpaign_link); //
